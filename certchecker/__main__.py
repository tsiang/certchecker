...
class CertChecker():
    ...
    def get_cert_exp_dict(self, cert_list):
        cert_exp_dict = dict()
    ...
    def create_json(self, cert_elb_dict, cert_exp_dict):
        cert_result = []
...
def main(profile):
    ...
    cc.cert_exp_dict = cc.get_cert_exp_dict(cc.cert_list)
    print(cc.create_json(cc.cert_elb_dict, cc.cert_exp_dict))
